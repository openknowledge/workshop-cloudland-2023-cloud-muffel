...
public class TopicRepository {
    @Value("${cloud-muffel.dynamodb.table}")
        ...
        return topicItems.stream().map(topicItem -> {
            ...
            try {
                topic = Topic.newTopic(topicItem.get("title").s())
                    ...
                    .createdOn(new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss Z").parse(topicItem.get("created_on").s()))
                    .build();
    ...
    public Optional<Topic> findTopicById(UUID id) {
        ...
        try {
            topic = Topic.newTopic(getTopicItem.get("title").s())
                ...
                .inCategory(category)
                .createdOn(new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss Z").parse(getTopicItem.get("created_on").s()))
    ...
    public void addTopic(Topic topic) {
        ...
        topicItem.put("created_on", AttributeValue.builder().s(new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss Z").format(topic.getCreatedOn())).build());
        ...
        topic.getPosts().forEach(post -> {
            ...
            postItem.put("created_on", AttributeValue.builder().s(
                new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss Z").format(post.getCreatedOn())
            ).build());
